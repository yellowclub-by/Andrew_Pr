...
async def cap(message: types.Message):
    ...
    text = '''<b>Эта черная рваная кепка — идеальное дополнение к вашему стильному образу.</b>\n
...
async def sunglasses(message: types.Message):
    ...
    text = '''<b>Эти черные модные очки станут ярким акцентом в вашем гардеробе.</b>\n
...
async def jacket(message: types.Message):
    ...
    text = '''<b>Эта черная куртка сочетает в себе стиль и функциональность.</b>\n
...
async def sweatshirt(message: types.Message):
    ...
    text = '''<b>Этот черный свитшот станет незаменимой частью вашего гардероба.</b>\n
...
async def t_shirt(message: types.Message):
    ...
    text = '''<b>Эта черная футболка - это классика стиля и удобства.</b>\n
...
async def jeans(message: types.Message):
    ...
    text = '''<b>Эти джинсы - надежный выбор для стильного повседневного образа.</b>\n
